...
class IDU extends Module {
  ...
  contr_code := Lookup(io.Inst,0.U,Array(
    BitPat("b???????_?????_?????_???_?????_00101_11") -> 1.U,
    BitPat("b???????_?????_?????_011_?????_00000_11") -> "b1_0_00011_00000_000_00000000".U, //auipc
    BitPat("b???????_?????_?????_011_?????_01000_11") -> "b1_0_00001_00000_001_00000000".U, //ld
    BitPat("b???????_?????_?????_000_?????_00100_11") -> "b0_1_00001_00000_000_11111111".U, //sd
