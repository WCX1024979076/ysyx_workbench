...
class IDU extends Module {
  ...
  var contr_code  = ListLookup(io.Inst,List(0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U),Array(
    ...
    BitPat("b???????_?????_?????_010_?????_00000_11") -> List(1.U, 0.U, AluSrc1Opcode.r1,        AluSrc2Opcode.imm,     AluOpcode.beq, PcSrccode.branch, RinCtlcode.memoutw,"b00000000".U), //beqi
    BitPat("b???????_?????_?????_011_?????_00100_11") -> List(1.U, 0.U, AluSrc1Opcode.r1,        AluSrc2Opcode.imm,     AluOpcode.sltu,PcSrccode.branch, RinCtlcode.memoutw,"b00000000".U), //sltiu
