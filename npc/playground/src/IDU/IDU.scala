...
class IDU extends Module {
  ...
  contr_code := Lookup(io.Inst,0.U(23.W),Array(
    BitPat("b?????????????????011?????0000011") -> "b1_0_00011_00000_000_00000000".U, //auipc
    BitPat("b?????????????????011?????0100011") -> "b1_0_00001_00000_001_00000000".U, //ld
    BitPat("b?????????????????000?????0010011") -> "b0_1_00001_00000_000_11111111".U, //sd
    BitPat("b?????????????????000?????0010011") -> "b1_0_00001_00000_000_00000000".U, //addi
    BitPat("b0000000??????????000?????0110011") -> "b1_0_00010_00000_000_00000000".U, //add
    BitPat("b?????????????????000?????0011011") -> "b1_0_00001_00000_011_00000000".U, //addiw
    BitPat("b0000000??????????000?????0111011") -> "b1_0_00010_00000_011_00000000".U, //addw
    BitPat("b0000000??????????001?????0110011") -> "b1_0_01001_00000_000_00000000".U, //sll
    BitPat("b000000???????????001?????0010011") -> "b1_0_01001_00000_000_00000000".U, //slli
    BitPat("b0000000??????????101?????0110011") -> "b1_0_01010_00000_000_00000000".U, //srl
    BitPat("b000000???????????101?????0010011") -> "b1_0_01010_00000_000_00000000".U, //srli
    BitPat("b0100000??????????101?????0110011") -> "b1_0_01011_00000_000_00000000".U, //sra
    BitPat("b010000???????????101?????0010011") -> "b1_0_01011_00000_000_00000000".U, //srai

    BitPat("b?????????????????????????1101111") -> "b1_0_00100_00001_000_00000000".U, //jal
    BitPat("b?????????????????000?????1100111") -> "b1_0_00100_00010_000_00000000".U, //jalr
    BitPat("b?????????????????000?????1100011") -> "b0_0_00101_00011_000_00000000".U, //beq
    BitPat("b?????????????????010?????0000011") -> "b1_0_00001_00000_010_00000000".U, //lw
    BitPat("b?????????????????011?????0010011") -> "b1_0_00110_00000_000_00000000".U, //sltiu
    BitPat("b?????????????????001?????1100011") -> "b0_0_00111_00011_000_00000000".U, //bne
    BitPat("b0100000??????????000?????0110011") -> "b1_0_01000_00000_000_00000000".U, //sub
  ))
