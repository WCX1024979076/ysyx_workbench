...
class IDU extends Module {
  ...
  var contr_code  = ListLookup(io.Inst,List(0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U),Array(
    ...
    BitPat("b000000?_?????_?????_101_?????_00110_11") -> List(1.U, 0.U, AluSrc1Opcode.r1,        AluSrc2Opcode.imm_5_0, AluOpcode.srl,  PcSrccode.add4,   RinCtlcode.aluoutw,"b00000000".U), //srliw
