...
class IDU extends Module {
  ...
  var contr_code  = ListLookup(io.Inst,List(0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U, 0.U),Array(
    ...
    BitPat("b000000?_?????_?????_001_?????_00110_11") -> List(1.U, 0.U, AluSrc1Opcode.r1_31_0,   AluSrc2Opcode.r2,      AluOpcode.sll32,  PcSrccode.add4,   RinCtlcode.aluout32, "b00000000".U), //slliw
