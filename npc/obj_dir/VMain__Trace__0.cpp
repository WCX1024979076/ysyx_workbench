...
void VMain___024root__trace_chg_sub_0(VMain___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+93,((0xffU & vlSelf->Main__DOT__exu__DOT___AluOut_T_77[0U])),8);
        tracep->chgQData(oldp+94,(((0x80U & vlSelf->Main__DOT__exu__DOT___AluOut_T_77[0U])
                                    ? 0xffffffffffffffULL
                                    : 0ULL)),56);
        ...
        tracep->chgQData(oldp+97,(((1U & (IData)((vlSelf->Main__DOT__exu__DOT__mem_Rdata 
                                    ...
                                    ? 0xffffffffffffffULL
                                    : 0ULL)),56);
        tracep->chgQData(oldp+99,(((0x4000U & vlSelf->Main__DOT__exu__DOT___AluOut_T_77[0U])
                                    ? 0x1ffffffffffffULL
                                    : 0ULL)),49);
        tracep->chgSData(oldp+101,((0x7fffU & vlSelf->Main__DOT__exu__DOT___AluOut_T_77[0U])),15);
        ...
        tracep->chgIData(oldp+105,(vlSelf->Main__DOT__exu__DOT___AluOut_T_77[0U]),32);
        tracep->chgIData(oldp+106,(((vlSelf->Main__DOT__exu__DOT___AluOut_T_77[0U] 
                                     >> 0x1fU) ? 0xffffffffU
                                     : 0U)),32);
