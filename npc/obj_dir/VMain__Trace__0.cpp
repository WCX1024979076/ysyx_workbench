...
void VMain___024root__trace_chg_sub_0(VMain___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgBit(oldp+93,((0x100073U == (IData)(vlSelf->Main__DOT__ifu__DOT__mem_Rdata))));
        tracep->chgCData(oldp+94,((0x7fU & (IData)(vlSelf->Main__DOT__ifu__DOT__mem_Rdata))),7);
        tracep->chgCData(oldp+95,(vlSelf->Main__DOT__idu__DOT__inst_type),3);
        tracep->chgQData(oldp+96,((QData)((IData)((0xfffU 
                                                   & (IData)(
                                                             (vlSelf->Main__DOT__ifu__DOT__mem_Rdata 
                                                              >> 0x14U)))))),64);
                                                    ...
                                                    | (0xff000U 
                                                       & ((IData)(
                                                                  (vlSelf->Main__DOT__ifu__DOT__mem_Rdata 
                                                                   >> 0xcU)) 
                                                          << 0xcU)))))),64);
        tracep->chgIData(oldp+106,(vlSelf->Main__DOT__idu__DOT__inst_flag),17);
        tracep->chgIData(oldp+107,(vlSelf->Main__DOT__idu__DOT__contr_code),23);
        tracep->chgQData(oldp+108,(vlSelf->Main__DOT__ifu__DOT__mem_Rdata),64);
    }
    tracep->chgBit(oldp+110,(vlSelf->clock));
    tracep->chgBit(oldp+111,(vlSelf->reset));
}
