...
VL_ATTR_COLD void VMain___024root__trace_full_sub_0(VMain___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullBit(oldp+4,((1U & (((0x13U == (0x707fU 
                                               & (IData)(vlSelf->Main__DOT__ifu__DOT__mem_Rdata)))
                                     ? 0x410000U : 0U) 
                                   >> 0x16U))));
    tracep->fullBit(oldp+5,((1U & (((0x13U == (0x707fU 
                                               & (IData)(vlSelf->Main__DOT__ifu__DOT__mem_Rdata)))
                                     ? 0x410000U : 0U) 
                                   >> 0x15U))));
    tracep->fullCData(oldp+6,((0x1fU & (((0x13U == 
                                          (0x707fU 
                                           & (IData)(vlSelf->Main__DOT__ifu__DOT__mem_Rdata)))
                                          ? 0x410000U
                                          : 0U) >> 0x10U))),5);
    tracep->fullCData(oldp+7,((0x1fU & (((0x13U == 
                                          (0x707fU 
                                           & (IData)(vlSelf->Main__DOT__ifu__DOT__mem_Rdata)))
                                          ? 0x410000U
                                          : 0U) >> 0xbU))),5);
    tracep->fullCData(oldp+8,((7U & (((0x13U == (0x707fU 
                                                 & (IData)(vlSelf->Main__DOT__ifu__DOT__mem_Rdata)))
                                       ? 0x410000U : 0U) 
                                     >> 8U))),3);
                                                 ...
                                                 | (0xff000U 
                                                    & ((IData)(
                                                               (vlSelf->Main__DOT__ifu__DOT__mem_Rdata 
                                                                >> 0xcU)) 
                                                       << 0xcU)))))),64);
    tracep->fullIData(oldp+116,(((0x13U == (0x707fU 
                                            & (IData)(vlSelf->Main__DOT__ifu__DOT__mem_Rdata)))
                                  ? 0x410000U : 0U)),23);
