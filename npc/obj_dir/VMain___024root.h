...
VL_MODULE(VMain___024root) {
  public:
    ...
    struct {
        ...
        CData/*3:0*/ Main__DOT__idu__DOT__contr_code_5;
        CData/*3:0*/ Main__DOT__idu__DOT___contr_code_T_549;
        CData/*0:0*/ Main__DOT__exu__DOT__SignU;
        CData/*0:0*/ Main__DOT__exu__DOT__SignS;
        ...
        VlWide<4>/*127:0*/ Main__DOT__exu__DOT___AluOut_T_76;
