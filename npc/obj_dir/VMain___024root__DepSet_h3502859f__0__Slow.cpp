...
VL_ATTR_COLD void VMain___024root___ctor_var_reset(VMain___024root* vlSelf) {
    ...
    vlSelf->Main__DOT__idu__DOT___contr_code_T_191 = VL_RAND_RESET_I(1);
    vlSelf->Main__DOT__idu__DOT__contr_code_2 = VL_RAND_RESET_I(2);
    vlSelf->Main__DOT__idu__DOT__contr_code_3 = VL_RAND_RESET_I(3);
    vlSelf->Main__DOT__idu__DOT___contr_code_T_392 = VL_RAND_RESET_I(2);
    vlSelf->Main__DOT__idu__DOT___contr_code_T_491 = VL_RAND_RESET_I(8);
    ...
    VL_RAND_RESET_W(128, vlSelf->Main__DOT__exu__DOT___AluOut_T_77);
    vlSelf->Main__DOT__exu__DOT___DataIn_T_41 = VL_RAND_RESET_Q(64);
