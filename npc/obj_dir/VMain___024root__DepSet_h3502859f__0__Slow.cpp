...
VL_ATTR_COLD void VMain___024root___ctor_var_reset(VMain___024root* vlSelf) {
    ...
    vlSelf->Main__DOT__idu__DOT___contr_code_T_228 = VL_RAND_RESET_I(2);
    ...
    VL_RAND_RESET_W(96, vlSelf->Main__DOT__exu__DOT___DataIn_T_6);
    vlSelf->Main__DOT__exu__DOT___DataIn_T_13 = VL_RAND_RESET_Q(64);
